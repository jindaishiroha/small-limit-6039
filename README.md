...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/small-limit-6039
```

A live public deployment of this template is available at [https://small-limit-6039.templates.workers.dev](https://small-limit-6039.templates.workers.dev)
